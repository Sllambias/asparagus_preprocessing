...
def process(
    ...
    dataset_config = DatasetConfig(
        ...
        split=None,
        patterns_exclusion=["func", "fmap"],
        patterns_DWI=["dwi"],
        patterns_PET=[],
        patterns_perfusion=[],
        patterns_m0=[],
        patterns_bidsify=[r"(sub-NDAR[A-Za-z0-9]{8})"],
    ...
    if saving_config.bidsify or saving_config.save_dset_metadata:
        ...
        pd.concat(dfs, ignore_index=True).to_csv(demographics_csv_path, index=False)
