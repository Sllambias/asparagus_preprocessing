from asparagus_preprocessing.configs.preprocessing_presets import get_FOMO_saving_config, get_iso_preprocessing_config
from asparagus_preprocessing.datasets_pretraining.PT037_age_ility import process
...
def main(
    ...
    process(
        ...
        subdir=subdir,
        processes=processes,
        task_name="PT037i_age_ility_ISO",
    )
