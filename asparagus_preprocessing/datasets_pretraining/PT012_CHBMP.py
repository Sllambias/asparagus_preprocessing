...
def process(
    ...
    dataset_config = DatasetConfig(
        ...
        split=None,
        patterns_exclusion=["objects", "fmap"],
        patterns_DWI=["dwi"],
        patterns_PET=[],
        patterns_perfusion=[],
        patterns_m0=[],
        patterns_bidsify=[r"sub-(CBM\d{5})"],
    ...
    if saving_config.bidsify or saving_config.save_dset_metadata:
        demographics_csv_path = os.path.join(source_dir, "CHBMP", "BIDS_dataset", "participants.csv")
