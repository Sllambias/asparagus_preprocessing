...
def process(
    ...
    dataset_config = DatasetConfig(
        ...
        split=None,
        patterns_exclusion=["fmap", "func"],
        patterns_DWI=["dwi"],
        patterns_PET=[],
        patterns_perfusion=[],
        patterns_m0=[],
        patterns_bidsify=[r"sub-([A-Z]\d+)"],
        df_columns=["participant_id", "session_id", "sex", "age", "handedness", "group"],
    )
    ...
    if saving_config.bidsify or saving_config.save_dset_metadata:
        demographics_csv_path = os.path.join(source_dir, "BrainLat_Demographic_MRI.csv")
        ...
        expanded_df, subjects_df, mri_info_df = extract_demographics(
            ...
            sex_mapping={0: "F", 1: "M"},
            handedness_mapping={0: "L", 1: "R", 4: "A"},
