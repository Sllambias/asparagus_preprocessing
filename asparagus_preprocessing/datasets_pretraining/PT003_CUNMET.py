...
def process(
    ...
    dataset_config = DatasetConfig(
        ...
        patterns_DWI=[],
        patterns_PET=[],
        patterns_perfusion=["asl", "MZero"],
        patterns_m0=["MZero"],
        patterns_bidsify=[r"sub-([0-9]{4})"],
    ...
    if saving_config.bidsify or saving_config.save_dset_metadata:
        demographics_csv_path = os.path.join(source_dir, "cunmet_phenotypic_open.csv")
        ...
        expanded_df, subjects_df, mri_info_df = extract_demographics(
            ...
            sex_mapping={1: "F", 2: "M"},
            group_mapping={1: "ADHD-MPH", 2: "ADHD-LPX", 3: "ADHD-GFC", 4: "ADHD-NAIVE"},
