...
def process(
    ...
    dataset_config = DatasetConfig(
        ...
        split=None,
        patterns_exclusion=["BOLD"],
        patterns_DWI=[],
        patterns_PET=[],
        patterns_perfusion=[],
        patterns_m0=[],
        patterns_bidsify=[r"(Sub\d{4}_Ses\d{1})"],
    ...
    if saving_config.bidsify or saving_config.save_dset_metadata:
        hardcoded_metadata = {
            "ANAT": {
                ...
                "SequenceName": "MEMPRAGE",
                "MRAcquisitionType": "3D",
                "ScanningSequence": "GR",
                "SequenceVariant": "SP\\MP",
                "SeriesDescription": "T1_MEMPRAGE",
                "ProtocolName": "T1_MEMPRAGE", 
                "SliceThickness": "1.2",
                "RepetitionTime": "2200",
                "InversionTime": "1100",
                "FlipAngle": "7"
        ...
        my_modality_overrides = {
            "ANAT1": {"suffix": "t1w", "folder": "anat"},
        }        
        demographics_csv_path = os.path.join(source_dir, "DataRelease_2014-04-22.csv")
