import os
from asparagus_preprocessing.utils.detect import recursive_find_and_group_files, get_bvals_and_bvecs_v3, recursive_find_files
...
def process(
    ...
    subdir: str = "Indi_Bejing",
    processes=12,
    task_name: str = "PT022_Bejing_Enhanced",
):
    ...
    bvals_DWI, bvecs_DWI = get_bvals_and_bvecs_v3(files_DWI, dataset_config.in_extensions)
    ...
    if saving_config.bidsify or saving_config.save_dset_metadata:
        ...
        demographics_csv_path = os.path.join(source_dir, "stce93_6_28_2025_2_32_51.csv")
