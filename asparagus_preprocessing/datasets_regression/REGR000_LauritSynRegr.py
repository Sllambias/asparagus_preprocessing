...
def main(
    ...
    dataset_config = DatasetConfig(
        task_name="REGR000_LauritSynRegr",
        in_extensions=[".pt"],
        n_classes=1,
        n_modalities=1,
...
def generate_random_regrcase(i, preprocessing_config, saving_config, target_dir, raw_labels_target_dir):
    dims = (
